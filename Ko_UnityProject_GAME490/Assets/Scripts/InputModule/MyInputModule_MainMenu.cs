...
namespace UnityEngine.EventSystems
{
    ...
    /// </remarks>
    public class MyInputModule_MainMenu : PointerInputModule
    {
        ...
        protected MyInputModule_MainMenu()
        {
        }
        ...
        public override void Process()
        {
            ...
            if (!ProcessTouchEvents() && input.mousePresent && FindObjectOfType<MainMenu>().isOptionsMenu == true)
            {
                ProcessMouseEvent();
            }
